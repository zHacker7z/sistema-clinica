    ...
    <form @submit.prevent="handleSubmit" novalidate>
      ...
      <div class="row" style="margin-top: 10px">
        ...
        <div class="field">
          ...
          <input v-model="phone" inputmode="numeric" maxlength="15" placeholder="(00) 00000-0000" @input="handlePhoneInput" />
        </div>
        <div class="field">
...
async function handleSubmit() {
  ...
  try {
    await register({ name: nameValue, email: emailValue, password: passwordValue, role: role.value, phone: phoneValue });
    ...
    error.value = extractErrorMessage(e, 'Não foi possível concluir seu cadastro.');
  }
}
</script>
